...
if Humanoid.RigType == Enum.HumanoidRigType.R15 then
    game.StarterGui:SetCore("ChatMakeSystemMessage", {
        Text = "Rig Type is not Supported, Use R6 to use.",
...
if game.Players.LocalPlayer.Character:FindFirstChild("CoolHubTutorial") or workspace:FindFirstChild("CoolHubTutorial") then
    game.StarterGui:SetCore("ChatMakeSystemMessage", {
        Text = "You are Already Animated. Reset to Execute again.",
        Color = Color3.fromRGB(255, 10, 70),
        TextSize = 18,
        Font = Enum.Font.Ubuntu
    });
...
CopyCharacter.Name = "HexAnimator" -- you can always change name.
